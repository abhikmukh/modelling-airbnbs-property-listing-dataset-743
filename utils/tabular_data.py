...
from utils.eda_utils import DataFrameInfo
...
class CleanTabularData:
    ...
    def remove_rows_with_missing_ratings(self) -> pd.DataFrame:
        """
        This function removes rows with missing ratings.
        """
    ...
    def combine_description_strings(self) -> pd.DataFrame:
        """
        This function combines the description strings.
        """
    ...
    def set_default_feature_values(self) -> pd.DataFrame:
        """
        This function sets default values for missing values in the features.
        """
    ...
    def clean_category_column(self) -> pd.DataFrame:
        """
        This function cleans the category column.
        """
        self.df['Category'] = \
    ...
    def drop_outliers(self):
        """
        This function drops outliers from the dataframe.
        """
...
def load_airbnb_data(data_df, label_column):
    """
    This function loads the Airbnb data and extracts the features and labels.
    """
